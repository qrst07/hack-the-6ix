 ...
 * 1. brew install sox: http://sox.sourceforge.net/
...
function infiniteStream(encoding, sampleRateHertz, languageCode, streamingLimit) {
  ...
  const speechCallback = (stream) => {
    ...
    resultEndTime =
      stream.results[0].resultEndTime.seconds * 1000 + Math.round(stream.results[0].resultEndTime.nanos / 1000000);
...
require('yargs')
  .demand(1)
  .command('infiniteStream', 'infinitely streams audio input from microphone to speech API', {}, (opts) =>
